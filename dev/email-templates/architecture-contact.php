...
<?php 
  if(isset($_POST['email'])){
	...
	$receiver="danilov@gastronom.by";
	$subject="Сообщение с сайта Продукт года-2017";
	...
	<tr>
	<td align='right' valign='top' style='border-top:1px solid #dfdfdf; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000; padding:7px 5px 7px 0;'>Обращение:</td>
	...
	<td align='left' valign='top' style='border-top:1px solid #dfdfdf; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000; padding:7px 0 7px 5px;'>".$from."</td>
		...
		<tr>
	<td align='right' valign='top' style='border-top:1px solid #dfdfdf; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000; padding:7px 5px 7px 0;'>Пакет или вопрос:</td>
	...
	<tr>
	<td align='right' valign='top' style='border-top:1px solid #dfdfdf; border-bottom:1px solid #dfdfdf; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000; padding:7px 5px 7px 0;'>Сообщение:</td>
...
$headers .= 'From: <'.$from.'>' . "\r\n";
   ...
   {	
   	 //Fail Message
      echo "Возникли проблемы с отпракой сообщения. Попробуйте, пожалуйста, еще раз";
   }
